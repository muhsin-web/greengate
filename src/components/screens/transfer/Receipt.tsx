...
const Receipt = ({ type }: { type: "user" | "bank" }) => {
    ...
    <SafeAreaView className="flex-1 bg-primary-foreground px-4">
      ...
      <ScrollView>
        <View className="bg-[#F3F4F6] rounded-3xl p-4 mt-3">
          ...
          <View className="bg-[#FCFCFC] my-6 self-center rounded-full py-4 px-6 mt-6">
          ...
          <View className="gap-3">
            <View className="flex-row items-center gap-2">
              ...
              <View className="flex-row items-center gap-2 bg-[#FCFCFC] rounded-full py-4 px-6">
      ...
      <Button type="secondary" title="Share" />
    </SafeAreaView>
  );
};
